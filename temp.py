...
label1 = Label(root, text='Temperature in Celsius =', font=('Arial', 25))
...
label4 = Label(root, text='Temperature in Fahrenheit =', font=('Arial', 25))
label4.place(x=200, y=400)

label5 = Label(root, text='Temperature in Celsius =', font=('Arial', 25))
...
label7 = Label(root, text='Temperature in Celsius =', font=('Arial', 25))
label7.place(x=200, y=600)

label8 = Label(root, text='Temperature in Kelvin =', font=('Arial', 25))
label8.place(x=200, y=700)

entry3 = Entry(root, font=('Arial', 25), textvariable=var3)
entry3.place(x=600, y=600)

label9 = Label(root, font=('Arial', 25))
label9.place(x=600, y=700)

def click3():
    label9.config(text='' + str(var3.get() + 273.15) + ' K')

button3 = Button(root, text='Convert', font=('Arial', 25), command=click3)
button3.place(x=920, y=600)
